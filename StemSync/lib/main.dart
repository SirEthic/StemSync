...
class _MixerScreenState extends State<MixerScreen> with SingleTickerProviderStateMixin, WidgetsBindingObserver {
  ...
  Widget _getIconForTrack(String filename) {
    ...
    if (lower.contains('bass')) return Image.asset('assets/bass_icon.png', width: 22, height: 22);
    if (lower.contains('guitar')) return Image.asset('assets/guitar_icon.png', width: 22, height: 22);
